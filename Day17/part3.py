# this one was wayyy to hard so hyperneutrino to the rescue! (solution creds to her)

import heapq
import functools
with open('input.txt') as reader:
    lines = [line.strip() for line in reader.readlines()]
grid = [[-1 if char == "@" else 0 if char == "S" else int(char) for char in line] for line in lines]
